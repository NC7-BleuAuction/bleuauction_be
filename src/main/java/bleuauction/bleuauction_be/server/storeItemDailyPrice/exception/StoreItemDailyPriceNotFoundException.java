...
public class StoreItemDailyPriceNotFoundException extends RuntimeException {
    ...
    private static final String DEFAULT_CONSTRUCTOR_MESSAGE =
            "[StoreItemDailyPriceNotFoundException] Not Found StoreItemDailyPrice";
    ...
    public StoreItemDailyPriceNotFoundException(DailyPriceStatus dailyPriceStatus) {
        super(
                String.format(
                        DEFAULT_CONSTRUCTOR_MESSAGE + ", Request dailyPriceNo No >>> %s",
                        dailyPriceStatus));
    }
    ...
    public StoreItemDailyPriceNotFoundException(Long dailyPriceNo) {
        super(
                String.format(
                        DEFAULT_CONSTRUCTOR_MESSAGE + ", Request dailyPriceNo No >>> %d",
                        dailyPriceNo));
    }
}
