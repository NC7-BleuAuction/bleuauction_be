...
public class AnswerService {
  ...
  public List<Answer> selectAnswerList(Long reviewNo, AnswerStatus answerStatus, int startPage, int pageRowCount) throws Exception {
    Pageable pageable = PageRequest.of(startPage, pageRowCount);
    return answerRepository.findAnswersByReviewNoAndAnswerStatusWithPagination(reviewNo, answerStatus, pageable);
  }
