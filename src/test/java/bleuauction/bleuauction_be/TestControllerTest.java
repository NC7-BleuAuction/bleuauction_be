...
class TestControllerTest {
    ...
    @MockBean private StoreComponentService storeComponentService;
    ...
    void healthCheckTest() throws Exception {
        mvc.perform(MockMvcRequestBuilders.get("/health").with(csrf())).andExpect(status().isOk());
    }
    ...
    void helloMethodTest() throws Exception {
        mvc.perform(MockMvcRequestBuilders.get("/api/test").with(csrf()))
