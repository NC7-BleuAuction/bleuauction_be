...
public class APILoginSuccessHandler implements AuthenticationSuccessHandler {
  ...
  public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response, Authentication authentication) throws IOException {
    ...
    log.info("onAuthenticationSuccess() - APIUserDTO  >>>>>>>>>>>>>>>>>>>>>>>>> {}", apiUserDTO.toString());


    String accessToken = jwtUtils.createAccessToken(new TokenMember(apiUserDTO.getMemberNo(), apiUserDTO.getMemberEmail(), apiUserDTO.getMemberName(), apiUserDTO.getMemberCategory()));
