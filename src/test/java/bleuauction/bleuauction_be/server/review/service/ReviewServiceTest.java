...
class ReviewServiceTest {
    ...
    @Mock private AttachRepository attachRepository;
    ...
    void testSelectReviewList() {
        ...
        given(
                        reviewRepository.findAllReviewsWithMembersByReviewStatus(
                                TEST_STORE_NO, ReviewStatus.Y, pageable))
                .willReturn(mockReviewList);

        // when
        List<Review> selectReviewList =
                reviewModuleService.selectReviewList(TEST_STORE_NO, TEST_START_PAGE);
    ...
    void testUpdateReview() throws Exception {
        ...
        given(reviewRepository.findById(mockOriginReview.getReviewNo()))
    ...
    void testDeleteReview() throws Exception {
        ...
        given(
                        reviewRepository.findByReviewNoAndReviewStatus(
                                mockReview.getReviewNo(), mockReview.getReviewStatus()))
